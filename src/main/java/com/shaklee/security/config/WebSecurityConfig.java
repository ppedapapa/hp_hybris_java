 ...
 */
package com.shaklee.security.config;
...
import com.shaklee.security.core.SAMLUserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public SAMLContextProvider contextProvider() {
        ...
        //((SAMLContextProviderImpl)contextProvider).setStorageFactory(new EmptyStorageFactory());
    ...
    public KeyManager keyManager() {
        ...
        Resource storeFile = loader.getResource("classpath:/saml/"+env.getProperty("app.security.saml.keystore"));
        String storePass =  env.getProperty("app.security.saml.keystore.pass");
        String defaultKey = env.getProperty("app.security.saml.keystore.key");
...
//	@Qualifier("idp-ssocircle")
    ...
    {
        DefaultResourceLoader loader = new DefaultResourceLoader();
        Resource metadataFile = loader.getResource("classpath:/saml/"+env.getProperty("app.security.saml.metadata"));


        //String idpSSOCircleMetadataURL = env.getProperty("app.security.saml.metadata") ;
        ...
        try {
            metadataProvider = new FilesystemMetadataProvider(metadataFile.getFile());
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public MetadataGenerator metadataGenerator() {
        ...
        metadataGenerator.setEntityId(env.getProperty("app.security.saml.entityId"));
    ...
    public SimpleUrlLogoutSuccessHandler successLogoutHandler() {
        ...
        successLogoutHandler.setDefaultTargetUrl("/hp-logout");
