delete from PROMO where ID = 60004;
...
insert into PROMO (ID, NAME, RULESET_GROUP, CODE, DESCRIPTION, PRIORITY, START_TS, END_TS, ACTIVE, COUNTRY_CODE) 
	values (60004, 'GOAL content', 'HP_CONTENT', 'HP_CONTENT_GOAL', 'GOAL Content keys', 100, '2016-01-01 00:00:00', '2050-01-01 00:00:00', 1, 'US');

insert into PROMO_RULESET_SEQ(PROMO_ID) values (60004);
...
insert into PROMO_COMPONENT (PROMO_ID, RULESET_ID, IMPLEMENTING_CLASS, JSON_SERIALIZED) 
	values (60004, @PROMO_RULESET_SEQ_VAL, 'com.shaklee.rulesets.healthQuestionaire.components.Age', 
	'{
		"min": 13,
		"max": 99
	}');
...
insert into PROMO_COMPONENT (PROMO_ID, RULESET_ID, IMPLEMENTING_CLASS, JSON_SERIALIZED) 
	values (60004, @PROMO_RULESET_SEQ_VAL, 'com.shaklee.healthPrint.components.GoalMessageKeyGenerator',
	'[{
		"prefix": "goal",
		"rules": {
			"OVERALL":{
