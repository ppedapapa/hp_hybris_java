...
insert into PROMO_COMPONENT (ID, PROMO_ID, RULESET_ID, IMPLEMENTING_CLASS) values (PROMO_COMPONENT_SEQ.nextval, 12775, PROMO_RULESET_SEQ.nextval,
...
insert into PROMO_COMPONENT (ID, PROMO_ID, RULESET_ID, IMPLEMENTING_CLASS, JSON_SERIALIZED) values (PROMO_COMPONENT_SEQ.nextval, 12775, PROMO_RULESET_SEQ.currval,
