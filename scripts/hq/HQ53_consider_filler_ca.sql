...
insert into PROMO_RULESET_SEQ(PROMO_ID) values (10053);
set @PROMO_RULESET_SEQ_VAL = LAST_INSERT_ID();

insert into PROMO_COMPONENT (PROMO_ID, RULESET_ID, IMPLEMENTING_CLASS) values (10053, @PROMO_RULESET_SEQ_VAL,
...
insert into PROMO_COMPONENT (PROMO_ID, RULESET_ID, IMPLEMENTING_CLASS) values (10053, @PROMO_RULESET_SEQ_VAL, 'com.shaklee.rulesets.healthQuestionaire.components.Age');
set @PROMO_COMPONENT_SEQ_VAL = LAST_INSERT_ID();
insert into PROMO_COMPONENT_PARAM (PROMO_COMPONENT_ID, NAME, VAL) values
...
insert into PROMO_COMPONENT_PARAM (PROMO_COMPONENT_ID, NAME, VAL) values
	...
	(@PROMO_COMPONENT_SEQ_VAL, 'sku', '57501'),
...
insert into PROMO_COMPONENT_PARAM (PROMO_COMPONENT_ID, NAME, VAL) values
	(@PROMO_COMPONENT_SEQ_VAL, 'bundle_name', 'CONSIDER'),
	(@PROMO_COMPONENT_SEQ_VAL, 'sku', '57073'),
	(@PROMO_COMPONENT_SEQ_VAL, 'bundle_size', 1),
...
insert into PROMO_COMPONENT_PARAM (PROMO_COMPONENT_ID, NAME, VAL) values
	(@PROMO_COMPONENT_SEQ_VAL, 'bundle_name', 'CONSIDER'),
	(@PROMO_COMPONENT_SEQ_VAL, 'sku', '53564'),
	(@PROMO_COMPONENT_SEQ_VAL, 'bundle_size', 1),
