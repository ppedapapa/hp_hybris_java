...
insert into PROMO_COMPONENT (ID, PROMO_ID, RULESET_ID, IMPLEMENTING_CLASS) values (PROMO_COMPONENT_SEQ.nextval, 10052, PROMO_RULESET_SEQ.nextval,
...
insert into PROMO_COMPONENT (ID, PROMO_ID, RULESET_ID, IMPLEMENTING_CLASS) values (PROMO_COMPONENT_SEQ.nextval, 10052, PROMO_RULESET_SEQ.currval, 
...
insert into PROMO_COMPONENT_PARAM (PROMO_COMPONENT_ID, NAME, VAL) values
	(PROMO_COMPONENT_SEQ.currval, 'bundle_name', 'CONSIDER'),
	(PROMO_COMPONENT_SEQ.currval, 'sku', '22073'),
	(PROMO_COMPONENT_SEQ.currval, 'bundle_size', 1),
...
insert into PROMO_COMPONENT_PARAM (PROMO_COMPONENT_ID, NAME, VAL) values
	(PROMO_COMPONENT_SEQ.currval, 'bundle_name', 'CONSIDER'),
	(PROMO_COMPONENT_SEQ.currval, 'sku', '32565'),
	(PROMO_COMPONENT_SEQ.currval, 'bundle_size', 1),
